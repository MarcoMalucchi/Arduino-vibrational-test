/*
Here we find the final version of the motor-controller sketch.
...
void loop() { // What to do while the system is ON.
  ...
  updateSerial(); // Lastly update the serial communication so that the user can change the state of the motor
